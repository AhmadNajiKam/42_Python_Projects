...
class Tree(Plant):
    def __init__(self, name: str, height: int, age: int, trunk: int, shade: int) -> None:
        super().__init__(name,height,age)
        self.trunk = trunk
        self.shade = shade
    ...
    def print_info(self) -> None:
        print(f"{self.name} (Tree): {self.height}cm, {self.age} days, {self.trunk} diameter")


class Vegetable(Plant):
    def __init__(self, name: str, height: int, age: int, season: str, nutrition_val: str ) -> None:
        super().__init__(name,height,age)
        self.season = season
    ...
    def print_info(self) -> None:
        print(f"{self.name} (Vegetable): {self.height}cm, {self.age} days, {self.season} harvest")
